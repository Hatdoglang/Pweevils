...
function displayDetails(data) {
  ...
  // Check if images array exists and display the first image, otherwise fall back to placeholder
  const imageUrl = (data.imageUrls && data.imageUrls.length > 0) ? data.imageUrls[0] : '{{ url_for("static", filename="img/placeholder-image-url.jpg") }}';
  subgenusImage.src = imageUrl;
